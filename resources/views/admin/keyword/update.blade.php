                    ...
                    <form action="{{route('admin.keyword.update',$keyword->id)}}" method="POST">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{$keyword->k_name}}" class="form-control" placeholder="Nhập từ khóa ..." name="k_name" >
                               
                            </div>
                            <div class="form-group">
                                <label for="">Mô tả</label>
                                <textarea type="text" class="form-control" placeholder="Nhập mô tả ..." rows="5" name="k_description" ></textarea>
